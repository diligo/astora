...
import tech.diligo.astora.collection.ImmutableCollection.ImmutableCollectionDelegate;
...
public interface ImmutableMap<K, V> extends Map<K, V> {
    ...
    public static final class ImmutableMapDelegate<K, V> implements ImmutableMap<K, V> {
        ...
        public ImmutableSet<Entry<K, V>> entrySet() {
            return new ImmutableSet.ImmutableSetDelegate<>(this.target.entrySet());
        }
        ...
        public ImmutableSet<K> keySet() {
            return new ImmutableSet.ImmutableSetDelegate<>(this.target.keySet());
        }
